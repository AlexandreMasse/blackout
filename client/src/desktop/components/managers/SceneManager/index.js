...
class SceneManager extends Component {
  ...
  initPIXI() {
    ...
    // this.ticker.add(this.renderScene(this.ticker.deltaTime));
  ...
  calculWidthScene(pct) {
    ...
    if (this.firstSplitAppear) {
      ...
      TweenMax.to(this, 1, {
        ...
        onUpdate: () => {
          TweenMax.set(this.refScene1, {
            scaleX: this.player1SplitScreenPourcentage,
            x: -3
          });
          ...
          TweenMax.set(this.refScene2, {
            x: window.innerWidth * this.player1SplitScreenPourcentage,
            scaleX: 1 - this.player1SplitScreenPourcentage
          });
  ...
  onReceiveHandle = (handle, player) => {
    ...
    if (this.splitScreenPercentageBeforeHandle !== null) {
      ...
      const handlePourcentage = isPlayer1
        ? handle * (1 - this.splitScreenPercentageBeforeHandle)
        : handle * this.splitScreenPercentageBeforeHandle;
      ...
      this.splitScreenPercentageBeforeHandle = this.props.store.users.find(
  ...
  render() {
    ...
    return (
      <>
        <div
          ref={ref => (this.refScene1 = ref)}
          className={classNames('scene-manager__player1', {
            'door-circle':
              store.isSplitScreen &&
              player1.currentScene === scenes.SCENEDOOR.name &&
              player1.fingerprint &&
              player1.status === 'superior'
          })}
          style={{
            width: window.innerWidth
          }}
        >
          <div
            className="scene-manager__player1__wrapper"
            style={{
              width: window.innerWidth
            }}
          >
        ...
        <div
          ref={ref => (this.refScene2 = ref)}
          className={classNames('scene-manager__player2', {
            'door-circle':
              store.isSplitScreen &&
              player2.currentScene === scenes.SCENEDOOR.name &&
              player2.fingerprint &&
              player2.status === 'superior'
          })}
          style={{
            width: window.innerWidth,
            height: window.innerHeight
        ...
        >
          <div
            className="scene-manager__player2__wrapper"
            style={{
              width: window.innerWidth
            }}
          >
