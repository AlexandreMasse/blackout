...
export default class SceneGenerator {
  ...
  init() {
    ...
    this.dispatch(
      setUserIndicationTitle({ userId: 'player1', title: this.formatMessage({ id: 'app.indication.power' }) })
    )
    this.dispatch(
      setUserIndicationTitle({ userId: 'player2', title: this.formatMessage({ id: 'app.indication.power' }) })
    )
    this.dispatch(
      setUserIndicationDescription({
        userId: 'player1',
