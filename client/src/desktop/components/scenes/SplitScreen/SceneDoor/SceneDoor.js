  ...
  updateStore(newStore) {
    ...
    if (this.currentPlayerFingerprint !== this.newPlayerFingerprint && this.newPlayerFingerprint === true) {
      if (this.status === 'superior') {
        ...
        this.dispatch(
          setUserIndicationTitle({ userId: this.player, title: this.formatMessage({ id: 'app.indication.doorA' }) })
        )
        this.dispatch(
          setUserIndicationDescription({
            userId: this.player,
            description: this.formatMessage({ id: 'app.indication.doorA.sentence' })
          })
        )
        ...
        this.dispatch(
          setUserIndicationTitle({ userId: this.player, title: this.formatMessage({ id: 'app.indication.doorD' }) })
        )
        this.dispatch(
          setUserIndicationDescription({
            userId: this.player,
            description: this.formatMessage({ id: 'app.indication.doorD.sentence' })
          })
        )
  ...
  init() {
    ...
    switch (this.status) {
      case 'superior':
        ...
        this.dispatch(
          setUserIndicationTitle({ userId: this.player, title: this.formatMessage({ id: 'app.indication.door' }) })
        )
        this.dispatch(
          setUserIndicationDescription({
            userId: this.player,
