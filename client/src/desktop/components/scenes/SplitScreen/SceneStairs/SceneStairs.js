...
export default class SceneStairs {
  ...
  init() {
    ...
    this.brt = new PIXI.BaseRenderTexture(
      this.spriteStairs.width,
      this.spriteStairs.height,
    ...
    if (this.player === 'player2') {
      this.dispatch(
        setUserIndicationTitle({
          userId: 'player1',
          title: this.formatMessage({ id: 'app.indication.stairs', defaultMessage: 'Go down to floor -3' })
        })
      );
      this.dispatch(
        setUserIndicationTitle({
      ...
      this.dispatch(
        setUserIndicationDescription({
          ...
          description: this.formatMessage({
            ...
            defaultMessage: 'Press right and left to keep balance.'
          })
        })
      );
      this.dispatch(
